"""
Django settings for interstatesengine_45224 project.
...
ROOT_URLCONF = 'interstatesengine_45224.urls'
...
WSGI_APPLICATION = 'interstatesengine_45224.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "interstatesengine_45224 API",
    "DESCRIPTION": "API documentation for interstatesengine_45224 App",
    "VERSION": "v1",
}
